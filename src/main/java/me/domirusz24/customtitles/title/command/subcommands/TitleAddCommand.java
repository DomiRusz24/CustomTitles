...
public class TitleAddCommand extends BaseSubCommand {

    @Language("Command.TitleConfig.TitleAdd.Description")
    public static String LANG_DESCRIPTION = "Add title.";
